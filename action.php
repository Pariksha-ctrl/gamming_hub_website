...
/******************** Displaying all four Categories Title **********************/
...
/********** Displaying products on Category based and for search keywords *************/
		...
		if($count > 0){
			echo "
				<div class='alert alert-warning'>
						...
						<b>This product is already added!</b>
				</div>
			";//not in video
		} else {
			...
			if (mysqli_num_rows($query) > 0) {
				echo "
					<div class='alert alert-warning'>
							<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
							<b>This product is already added into your cart!</b>
					</div>";
					exit();
			}
			$sql = "INSERT INTO `cart`
			...
			if (mysqli_query($con,$sql)) {
				echo "
					<div class='alert alert-success'>
						<a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
						<b>Product is Added Successfully in your cart!</b>
					</div>
				";
				exit();
			}			
...
/************************* Counting the number of cart items of the user **********************/

if (isset($_POST["count_item"])) {
	// with help of session id, we count the number of cart items of the user
	if (isset($_SESSION["uid"])) {
		$sql = "SELECT COUNT(*) AS count_item FROM cart WHERE user_id = $_SESSION[uid]";
	}else{
		//We make the use of unique ip address to count the no of cart items when the user is not logged in
...
/*************** Getting the items of cart from database to the dropdown menu ***************/
...
/****************** Deleting the cart item from the cart list ******************/
